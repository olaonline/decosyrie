  ...
  return (
    ...
    <div className="grid grid-cols-1  md:grid-cols-2 gap-8 items-center">
      ...
      <div className="cta-section text-center py-20" data-aos="zoom-in">
        ...
        <NavLink to='/products'>
        <button className="bg-customGreen-400 hover:bg-customGreen-500 text-white font-bold py-3 px-8 rounded-full transition-transform transform hover:scale-105">
          Shop Now
        </button></NavLink>
      </div>
    </div>
